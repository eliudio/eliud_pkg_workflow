...
typedef AssignmentWidgetProvider(AssignmentModel? value);
...
class AssignmentListWidget extends StatefulWidget with HasFab {
  ...
  bool? readOnly;
  String? form;
  AssignmentListWidgetState? state;
  bool? isEmbedded;

  AssignmentListWidget({ Key? key, required this.app, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);
      ...
      onPressed: () {
        Navigator.of(context).push(
          pageRouteBuilder(widget.app, page: BlocProvider.value(
              ...
              child: AssignmentForm(app:widget.app,
                  value: null,
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return AssignmentListItem(app: widget.app,
            value: value,
//            app: accessState.app,
