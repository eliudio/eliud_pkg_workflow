...
class WorkflowTaskListWidget extends StatefulWidget with HasFab {
  ...
  WorkflowTaskListWidget({ Key? key, required this.app, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);
      ...
      onPressed: () {
        Navigator.of(context).push(
          pageRouteBuilder(widget.app, page: BlocProvider.value(
              ...
              child: WorkflowTaskForm(app:widget.app,
                  value: null,
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return WorkflowTaskListItem(app: widget.app,
            value: value,
//            app: accessState.app,
  ...
  Widget? getForm(value, action) {
    if (widget.form == null) {
      return WorkflowTaskForm(app:widget.app, value: value, formAction: action);
    } else {
      return null;
    }
  }
