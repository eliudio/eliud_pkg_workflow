...
class WorkflowCache implements WorkflowRepository {
  ...
  final Map<String, WorkflowModel> fullCache = Map();
  ...
  @override
  StreamSubscription<List<WorkflowModel>> listen(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<WorkflowModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
