...
class _SelectAssignmentViewWidgetState extends State<SelectAssignmentViewWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<AssignmentViewListBloc>(context).add(
            AssignmentViewChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID!)));
    }
  }
