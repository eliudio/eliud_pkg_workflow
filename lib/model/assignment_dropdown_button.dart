...
typedef AssignmentChanged(String? value, int? privilegeLevel,);
...
class AssignmentDropdownButtonWidget extends StatefulWidget {
  ...
  AssignmentDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return AssignmentDropdownButtonWidgetState();
  }
}

class AssignmentDropdownButtonWidgetState extends State<AssignmentDropdownButtonWidget> {
  AssignmentListBloc? bloc;

  AssignmentDropdownButtonWidgetState();
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'assignments', widget.value, (newValue, _) {
                  setState(() {
