...
typedef AssignmentChanged(String? value);
...
class AssignmentDropdownButtonWidget extends StatefulWidget {
  ...
  AssignmentDropdownButtonWidget({ required this.app, this.value, this.trigger, this.optional, Key? key }): super(key: key);
