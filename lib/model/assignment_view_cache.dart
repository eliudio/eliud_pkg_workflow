...
class AssignmentViewCache implements AssignmentViewRepository {
  ...
  @override
  StreamSubscription<List<AssignmentViewModel>> listen(trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
  ...
  @override
  StreamSubscription<List<AssignmentViewModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
