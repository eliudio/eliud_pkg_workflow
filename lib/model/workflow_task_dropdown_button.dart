...
typedef WorkflowTaskChanged(String? value, int? privilegeLevel,);
...
class WorkflowTaskDropdownButtonWidget extends StatefulWidget {
  ...
  WorkflowTaskDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return WorkflowTaskDropdownButtonWidgetState();
  }
}

class WorkflowTaskDropdownButtonWidgetState extends State<WorkflowTaskDropdownButtonWidget> {
  WorkflowTaskListBloc? bloc;

  WorkflowTaskDropdownButtonWidgetState();
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'workflowTasks', widget.value, (newValue, _) {
                  setState(() {
